...
// isLoaded = false means that loading is continuing that is it is pending
// isLoaded = true means that loading is completed req is done

// isEmpty = False means that firebase.auth has user or not - false means no user | true means a user is there
